...
describe 'the metric names a reader is offered' do
  ...
  it 'offers the name the measurement read actually writes' do
    ...
    assert_includes Tectonic::BodyReadings::KNOWN, Tectonic::WithingsWeighIn::METRICS.fetch(11).first
  end
  ...
  it 'offers every name the measurement read can write' do
    Tectonic::WithingsWeighIn::METRICS.each_value do |(metric, _unit)|
